...
*/
	...
	*/
	...
	ZBNOAM = false;          // true/false removes ambient life from map better FPS
	...
	if (!ZOMusehclient && ZOMperformance) then {[1000,-1,false,100,1000,1000]execvm "ZOM\cache\main.sqf";};	
	if(!hasInterface && !isServer && ZOMperformance && ZOMusehclient && name player != ZOMhclientname) then {[1000,-1,false,100,1000,1000]execvm "ZOM\cache\main.sqf"};
